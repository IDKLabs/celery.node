...
class Base {
     ...
     * @constructor Base
     */
    constructor(broker, backend, queue = "celery", opts) {
        var _a, _b, _c, _d;
        this.conf = conf_1.defaultConf();
        this.conf.CELERY_BROKER = broker;
        this.conf.CELERY_BACKEND = backend;
        this.conf.CELERY_QUEUE = queue;
        this.conf.CELERY_BACKEND_OPTIONS = (_b = (_a = opts) === null || _a === void 0 ? void 0 : _a.backendOpts, (_b !== null && _b !== void 0 ? _b : {}));
        this.conf.CELERY_BROKER_OPTIONS = (_d = (_c = opts) === null || _c === void 0 ? void 0 : _c.brokerOpts, (_d !== null && _d !== void 0 ? _d : {}));
    }
    get broker() {
        if (!this._broker) {
